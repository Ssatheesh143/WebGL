...
window.addEventListener('DOMContentLoaded', function () {
    ...
    var canvas = document.getElementById("renderCanvas05");
   ...
   //Sun
    var sun = BABYLON.SceneLoader.ImportMesh("","assets/Lab/Labset/","EmbibeLab_only_Lab.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        var gl = new BABYLON.GlowLayer("glow", scene);
    });
    ...
    //ligth
    var ligth = BABYLON.SceneLoader.ImportMesh("","assets/Lab/ligth/","EmbibeLab_only_Lab.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        //var gl = new BABYLON.GlowLayer("glow", scene);
    });

    //tv
    var tv = BABYLON.SceneLoader.ImportMesh("","assets/Lab/Tv/","EmbibeLab_only_tv.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        //var gl = new BABYLON.GlowLayer("glow", scene);
    });

    //screen01
    var screen01 = BABYLON.SceneLoader.ImportMesh("","assets/Lab/screen/","EmbibeLab_only_screen01.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        //var gl = new BABYLON.GlowLayer("glow", scene);
    });

    //screen02
    var screen02 = BABYLON.SceneLoader.ImportMesh("","assets/Lab/screen/","EmbibeLab_only_screen02.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        //var gl = new BABYLON.GlowLayer("glow", scene);
    });
    ...
    var mat = new BABYLON.StandardMaterial("mat", scene);
      ...
      var videoTexture = new BABYLON.VideoTexture("video", ["./Assets/Lab/screen/HeartAni.mp4"], scene, true, true);

      mat.diffuseTexture = videoTexture;
      screen02.material = mat;
    ...
    var pot = BABYLON.SceneLoader.ImportMesh("","assets/Lab/pot/","EmbibeLab_only_pot.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        //var gl = new BABYLON.GlowLayer("glow", scene);
    });

    var anatomy = BABYLON.SceneLoader.ImportMesh("","assets/Lab/anatomy/","EmbibeLab_only_anatomy.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        
        //var gl = new BABYLON.GlowLayer("glow", scene);
    });

    var anatomyGlass = BABYLON.SceneLoader.ImportMesh("","assets/Lab/anatomy/","EmbibeLab_only_anatomy_glass.glb", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
        
    });

    var bioSet = BABYLON.SceneLoader.ImportMesh("","assets/Lab/bioset/","EmbibeLab_only_bioSet.babylon", scene,function(newMeshes) {
        scene.createDefaultCameraOrLight(true, true, true);
